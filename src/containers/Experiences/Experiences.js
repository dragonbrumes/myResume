  ...
  render() {
    ...
    return (
      <div className="experiences">
              <Helmet>
          <meta charSet="utf-8" />
          <title>Experiences Stephane Lanteri CV</title>
          <meta name="description" content="Stephane Lanteri Experiences - online CV" />
          <link rel="canonical" href="https://stephane.lanteri.fr/career" />
        </Helmet>
